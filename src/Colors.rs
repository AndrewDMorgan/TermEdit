        ...
        fn default() -> ColorBindings <'a> {
            ColorBindings {
                ...
                syntaxHighlighting: std::collections::HashMap::from([
                    ...
                    ((&TokenType::Bracket, &ColorTypes::TrueColor), Color::LightBlue),
                    ((&TokenType::SquirlyBracket, &ColorTypes::TrueColor), Color::Magenta),
                    ((&TokenType::Parentheses, &ColorTypes::TrueColor), Color::Magenta),
                    ((&TokenType::Variable, &ColorTypes::TrueColor), Color::White),
                    ((&TokenType::Member, &ColorTypes::TrueColor), Color::LightCyan),
                    ((&TokenType::Object, &ColorTypes::TrueColor), Color::LightRed),
                    ((&TokenType::Function, &ColorTypes::TrueColor), Color::LightMagenta),
                    ((&TokenType::Method, &ColorTypes::TrueColor), Color::LightBlue),
                    ((&TokenType::Number, &ColorTypes::TrueColor), Color::LightYellow),
                    ((&TokenType::Logic, &ColorTypes::TrueColor), Color::LightYellow),
                    ((&TokenType::Math, &ColorTypes::TrueColor), Color::LightYellow),
                    ((&TokenType::Assignment, &ColorTypes::TrueColor), Color::LightBlue),
                    ((&TokenType::Endl, &ColorTypes::TrueColor), Color::White),
                    ((&TokenType::Macro, &ColorTypes::TrueColor), Color::LightMagenta),
                    ((&TokenType::Const, &ColorTypes::TrueColor), Color::Cyan),
                    ((&TokenType::Barrow, &ColorTypes::TrueColor), Color::LightGreen),
                    ((&TokenType::Lifetime, &ColorTypes::TrueColor), Color::LightBlue),
